 ...
 *
 * @details
 * We read data from a row randomized file structure format with length indicated header record,
...
int main()
{
     ...
     cout << "A table of all the postal sorted by zip from row randomized length indicated records:" << endl
          << endl;
     cout << left << setw(5) << "HR"
          << setw(10) << "Zip Code"
          << setw(20) << "Place Name"
